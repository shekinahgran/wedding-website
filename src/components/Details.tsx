          ...
          <div className="content-card order-1">
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-gray-700 font-medium text-sm md:text-base">Dress Code</p>
          ...
          <div className="content-card space-y-6 md:space-y-8 order-2">
            ...
            <div className="relative pl-6 md:pl-8 border-l-2 border-dashed border-wildflower-green/30 space-y-10 md:space-y-12 max-w-sm mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-gray-500 text-xs md:text-sm mb-1">4:00 PM</p>
              </div>

              <div className="relative">
                <div className="absolute -left-[33px] md:-left-[41px] top-0 w-4 h-4 rounded-full bg-wildflower-yellow shadow-lg"></div>
                <h4 className="text-lg md:text-xl font-bold mb-1">Sip, Snack & Snap</h4>
                <p className="text-gray-500 text-xs md:text-sm mb-1">5:00 PM — 5:30 PM</p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-gray-500 text-xs md:text-sm mb-1">5:30 PM — 7:30 PM</p>
              </div>
            </div>
