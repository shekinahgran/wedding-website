  ...
  const categories = [
    {
      ...
      color: 'bg-blue-50',
      palette: ['#93c5fd', '#60a5fa', '#3b82f6', '#1e40af'], // Shades of Blue
    ...
    },
    {
      ...
      color: 'bg-pink-50',
      palette: ['#a78bfa', '#365314'], // Lavender & Dark Green/Barong detail
      description: 'MOH: Specifically Lavender gown. Best Man: Long Sleeve Barong and Black Pants.',
    ...
    },
    {
      ...
      color: 'bg-amber-50',
      palette: ['#f5f5dc', '#ede6d6', '#f3e5ab', '#dcc6b8'], // Beige & Champagne
    ...
    },
    {
      ...
      color: 'bg-purple-50',
      palette: ['#a78bfa', '#f97316', '#fbbf24', '#f43f5e', '#34d399'], // Lavender, Orange, Yellow, Pink, Green
      description: 'Girls: Colorful dresses (Lavender, Orange, Yellow, Pink, etc). Men: Short Sleeve Barong & Black Pants.',
    ...
    },
    {
      ...
      color: 'bg-orange-50',
      palette: ['#ffdbac', '#f8ad9d', '#ffb5a7'], // Peach tones
    ...
    },
    {
      ...
      color: 'bg-gray-100',
      palette: ['#000000', '#1a1a1a', '#262626'], // All Black
      description: 'All Black Attire. We invite our guests to wear their best all-black semi-formal or formal outfits.',
  ...
  return (
    <section id="attire" className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-12 md:mb-20">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 italic">Wedding Attire</h2>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {categories.map((cat, index) => (
          ...
          >
            ...
            <p className="text-gray-600 text-sm leading-relaxed italic mt-auto">
              {cat.description}
            </p>
          </motion.div>
        ))}
